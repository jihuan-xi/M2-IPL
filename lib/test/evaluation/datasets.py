...
dataset_dict = dict(
    ...
    rgbt234_miss=DatasetInfo(module=pt % "rgbt234", class_name="RGBT234Dataset", kwargs=dict()),

    lashertestingset=DatasetInfo(module=pt % "lashertestingset", class_name="LasHeRtestingSetDataset", kwargs=dict()),
    lashertestingset_miss=DatasetInfo(module=pt % "lashertestingset", class_name="LasHeRtestingSetDataset", kwargs=dict()),
    
    # lashertestingset=DatasetInfo(module=pt % "lashertestingset", class_name="LasHeRtestingSetDataset", kwargs=dict()),
    # lashertestingset_lmdb=DatasetInfo(module=pt % "lashertestinglmdb", class_name="LasHeRTestLmdbDataset", kwargs=dict()),
    vtuav_miss=DatasetInfo(module=pt % "vtuav", class_name="VTUAVDataset", kwargs=dict()),

    vtuav=DatasetInfo(module=pt % "vtuav", class_name="VTUAVDataset", kwargs=dict()),
    urvis=DatasetInfo(module=pt % "urvis", class_name="UrvisDataset", kwargs=dict())
