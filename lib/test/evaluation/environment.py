...
class EnvSettings:
    def __init__(self):
        ...
        self.lashertestingset_path = '/data1/Datasets/Tracking/LasHeR/'

        self.urvis_path = '/data_G/urvis/public_data/'
...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.rgbt210_path = '../RGBT210/'
        self.rgbt234_path = '../RGBT234/'
        self.gtot_path = '../Tracking/GTOT/'
        self.lasher_path = '../data1/Datasets/Tracking/LasHeR/'
        self.lashertestingSet_path = '../Tracking/LasHeR/'
